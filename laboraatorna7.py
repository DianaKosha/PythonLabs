...
lab5_count =  count_of_word("https://www.wikipedia.org") #звідки береться файл записуємо
#в змінну lab5_count
#виклик ф-цій з класу
lab5_count.file_get()
lab5_count.text_clean()
lab5_count.number_words()
lab5_count.result_main()
